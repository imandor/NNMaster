...
if __name__ == '__main__':
    ...
    for i,model_path in enumerate(model_path_list):
        ...
        save_path = model_path + "images/" + image_title_list[i]+".png"
        plot_performance_comparison(path_1, 1, path_2, -1, "Accuracy, when decoding next well", "Accuracy, when decoding last well",save_path,"darkviolet")
