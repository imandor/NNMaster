...
if __name__ == '__main__':
    ...
    for i,model_path in enumerate(model_path_list):
        ...
        plot_performance_comparison(path_1, 1, path_2, -1, "Accuracy, when decoding next well","Accuracy, when decoding next well",save_path,"darkviolet",add_trial_numbers=True)