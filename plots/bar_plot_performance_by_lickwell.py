...
if __name__ == '__main__':
    ...
    for i,path in enumerate(model_path_list):
        plot_metric_details_by_lickwell(path + "output/", 1,path+"images/compare_wells_" + image_title_list[i]+"_next.png")
        plot_metric_details_by_lickwell(path + "output/", -1,path+"images/compare_wells_" + image_title_list[i]+"_last.png")
