...
# Removes a portion of the lick events and checks if performance changes
    ...
    model_path = "C:/Users/NN/Desktop/Master/experiments/Experiments for thesis 2/well decoding/hc_phase/"
    save_path=model_path+"images/"
    barcolor = "darkviolet"
    add_trial_numbers=True
    # load fraction and std data
    path_hc = model_path + "output/"
    path_pfc = "C:/Users/NN/Desktop/Master/experiments/Experiments for thesis 2/well decoding/pfc_phase/output/"
    ...
    ax1.set_xticklabels(['rewarded', 'not rewarded', 'ensuing'], fontsize=fontsize)
    ...
    ax2.set_xticklabels(['rewarded', 'not rewarded', 'preceding'], fontsize=fontsize)
    ...
    ax3.set_xticklabels(['rewarded', 'not rewarded', 'ensuing'], fontsize=fontsize)
    if add_trial_numbers is True:
