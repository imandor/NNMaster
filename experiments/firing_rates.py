...
def print_average_overlap(paths,filter_factor=1):
    """

    :param paths: list of paths of the two neural activity output files produced by this module
    :param filter_factor: kepps fraction of neurons from data set and filters out rest
    :return:
    """
    data_collection = []
    for path in paths:
...
if __name__ == '__main__':
    ...
    print_average_overlap(paths_hc)
    # print_average_overlap(paths_pfc)
    print_table(paths)
    ...
    if preferred_well == "current":
        save_as_pickle("C:/Users/NN/Desktop/deleteme/current_well_" + dataset+ ".pkl",preferred_well_by_neuron_list)
        save_as_pickle("C:/Users/NN/Desktop/deleteme/current_firing_rate_" + dataset+ ".pkl",preferred_well_firing_rate_list)
    if preferred_well == "target":
        save_as_pickle("C:/Users/NN/Desktop/deleteme/target_well_" + dataset+ ".pkl",preferred_well_by_neuron_list)
        save_as_pickle("C:/Users/NN/Desktop/deleteme/target_firing_rate_" + dataset+ ".pkl",preferred_well_firing_rate_list)
    ...
    edit_axis(neurons_by_well, xticklabels, time_range=1,color=color_list[0], label="PFC", ax=ax1, errorbar=None, plot_error_bars=False, y_label="neurons", x_label="")
