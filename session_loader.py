...
def read_file():
    ...
    initial_detection_timestamp =  initial_detection_timestamp  # %the first lick is at homewell for which the initial lick timing is not measured # TODO I removed [] + from this
