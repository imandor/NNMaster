...
mlp = Map()
mlp.fc1 = Map()
mlp.fc1.weights = tf.truncated_normal(shape=(10*111,400), stddev=0.01) # 56, 75, 111, 147
...
mlp_discrete.fc1.weights = tf.truncated_normal(shape=(11*56,100), stddev=0.01) # 36, 56, 75, 111, 147
# [147, 133, 118, 103, 89, 74, 59, 45, 30, 15]
