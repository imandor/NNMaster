...
mlp = Map()
mlp.fc1 = Map()
mlp.fc1.weights = tf.truncated_normal(shape=(166*10,128), stddev=0.01) # 166 * 17
...
sp1 = Map()
sp1.conv1 = Map()
sp1.conv1.weights = tf.truncated_normal(shape=(166, 5, 1, 32), stddev=0.1)
...
sp2 = Map()
sp2.conv1 = Map()
sp2.conv1.weights = tf.truncated_normal(shape=(166, 1, 1, 100), stddev=0.01)
